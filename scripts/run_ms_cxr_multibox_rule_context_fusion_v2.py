#!/usr/bin/env python
"""MS-CXR rule-context multi-box set prediction v2.
...
EXP_NAME = "ms_cxr_multibox_rule_context_fusion_v2"
...
def make_contact_sheet(groups: dict[str, dict[str, Any]], pred_rows: pd.DataFrame) -> None:
    method = "rule_context_multibox_yolo_dino_v2"
...
def write_report(
    ...
    lines = [
        "# MS-CXR Multi-box Rule-context Fusion V2",
        "",
        "## 한 줄 결론",
        "",
        (
...
def main() -> None:
    ...
    method_preds: dict[str, dict[str, list[dict[str, Any]]]] = {
        "rule_context_multibox_yolo_dino_v2": v2_preds,
    }
    ...
    if "yolo_dino_rule_fusion_v1" in singleton_methods:
        ...
        method_preds["hybrid_singlebox_fusion_plus_context_multibox_v2"] = hybrid
    ...
    method_preds["yolov8n_yolov8s_detection_set_val_tuned"] = detection_set_baseline(eval_groups_all, eval_candidates, det_params)
    ...
    boot_rows = []
    comparisons = [
        ("hybrid_singlebox_fusion_plus_context_multibox_v2", "yolo_dino_rule_fusion_v1"),
        ("hybrid_singlebox_fusion_plus_context_multibox_v2", "medrpg_rowlevel_full_phrase_s42"),
        ("hybrid_singlebox_fusion_plus_context_multibox_v2", "medrpg_rowlevel_full_phrase_s13"),
        ("hybrid_singlebox_fusion_plus_context_multibox_v2", "medrpg_rowlevel_full_phrase_s2026"),
        ("rule_context_multibox_yolo_dino_v2", "yolo_dino_rule_fusion_v1"),
        ("rule_context_multibox_yolo_dino_v2", "yolov8n_yolov8s_detection_set_val_tuned"),
        ("rule_context_multibox_yolo_dino_v2", "medrpg_rowlevel_full_phrase_s42"),
    ...
    own = summary[(summary.method == "rule_context_multibox_yolo_dino_v2") & (summary.subset == "eval_phrase_groups_all")].iloc[0]
    ...
    hybrid_row = summary[
        (summary.method == "hybrid_singlebox_fusion_plus_context_multibox_v2")
