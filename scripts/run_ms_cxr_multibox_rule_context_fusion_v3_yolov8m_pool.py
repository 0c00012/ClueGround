...
EXP_NAME = "ms_cxr_multibox_rule_context_fusion_v3_yolov8m_pool"
...
def make_contact_sheet(groups: dict[str, dict[str, Any]], pred_rows: pd.DataFrame) -> None:
    method = "rule_context_multibox_yolo_dino_v3_yolov8m_pool"
...
def main() -> None:
    ...
    parser.add_argument("--candidate-tags", default="yolov8n,yolov8s,yolov8m")
    ...
    method_preds: dict[str, dict[str, list[dict[str, Any]]]] = {
        "rule_context_multibox_yolo_dino_v3_yolov8m_pool": v2_preds,
    }
    ...
    if "yolo_dino_rule_fusion_v1" in singleton_methods:
        ...
        method_preds["hybrid_singlebox_fusion_plus_context_multibox_v3_yolov8m_pool"] = hybrid
    ...
    boot_rows = []
    comparisons = [
        ("hybrid_singlebox_fusion_plus_context_multibox_v3_yolov8m_pool", "hybrid_singlebox_fusion_plus_context_multibox_v2"),
        ("hybrid_singlebox_fusion_plus_context_multibox_v3_yolov8m_pool", "yolo_dino_rule_fusion_v1"),
        ("hybrid_singlebox_fusion_plus_context_multibox_v3_yolov8m_pool", "medrpg_rowlevel_full_phrase_s42"),
        ("hybrid_singlebox_fusion_plus_context_multibox_v3_yolov8m_pool", "medrpg_rowlevel_full_phrase_s13"),
        ("hybrid_singlebox_fusion_plus_context_multibox_v3_yolov8m_pool", "medrpg_rowlevel_full_phrase_s2026"),
        ("rule_context_multibox_yolo_dino_v3_yolov8m_pool", "rule_context_multibox_yolo_dino_v2"),
        ("rule_context_multibox_yolo_dino_v3_yolov8m_pool", "yolo_dino_rule_fusion_v1"),
        ("rule_context_multibox_yolo_dino_v3_yolov8m_pool", det_method),
        ("rule_context_multibox_yolo_dino_v3_yolov8m_pool", "medrpg_rowlevel_full_phrase_s42"),
    ...
    own = summary[(summary.method == "rule_context_multibox_yolo_dino_v3_yolov8m_pool") & (summary.subset == "eval_phrase_groups_all")].iloc[0]
    ...
    hybrid_row = summary[
        (summary.method == "hybrid_singlebox_fusion_plus_context_multibox_v3_yolov8m_pool")
